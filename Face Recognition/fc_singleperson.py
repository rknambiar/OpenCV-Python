...
#Collect the dataset from folder with name - person 
def collect_dataset():
    images = []
    labels = []
    labels_dic = {}
...
# Train the dataset with EigenFace detector
def train_dataset():
...
def predict(faces,recognizer,labels_dic):
    face = faces[0]
